...
# ------------------------------
# Animacija koristenjem scitools
# ------------------------------
#if opcija == 1:
#    # Homogeni vod
#    x = np.linspace(0.,L,Nx)
#    for j in xrange(0,Nt,15):
#        tt = fi[:,j]
#        plot(x, tt, 'b-', axis=[x[0],x[-1],-1.,1.], 
#             xlabel='duljina', ylabel='napon', grid=True)
#
#elif opcija == 2:
...
#    for j in xrange(0,Nt,15):
#        tt = fi[:,j]
#        plot(x0, y0, 'k--', x, tt, 'b-', axis=[x[0],x[-1],-1.,1.],
#             xlabel='duljina', ylabel='napon', grid=True)
#
#elif opcija == 3:
...
#    for j in xrange(0,Nt,15):
#        tt = fi[:,j]
#        plot(x0, y0, 'k--', x, tt, 'b-', axis=[x[0],x[-1],-1.5,1.5],
#             xlabel='duljina', ylabel='napon', grid=True)
